...
BLOG_AUTHOR = "fbus"  # (translatable)
BLOG_TITLE = "Multi-Phase Brothel"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://multiphasebrothel.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://multiphasebrothel.com/"
BLOG_EMAIL = "fbus@example.com"
BLOG_DESCRIPTION = "a place to stash info about synth related projects"  # (translatable)
...
#          with a ``/``, otherwise end them with ``/index.rst`` — or
#          else they won’t be highlighted when active.

NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("/blog/", "Posts"),
        ("/ken-stone-cat-girl-synth/", "CGS"),
        ("/look-mum-no-computer-kosmo-synth/", "Kosmo"),
    ),
}
...
THEME = "bootblog4"
#THEME = "willy-theme" # Seems to be broken right now.
...
# The page might also be placed in /destination/pagename/index.rst
...
# Final locations are:
# output / TRANSLATION[lang] / TAG_PATH / index.rst (list of tags)
...
#     output / TRANSLATION[lang] / TAG_PATH / index.rst
...
# Final locations are:
# output / TRANSLATION[lang] / CATEGORY_PATH / index.rst (list of categories)
...
#     output / TRANSLATION[lang] / CATEGORY_PATH / index.rst
...
# output / TRANSLATION[lang] / AUTHOR_PATH / index.rst (list of authors)
...
# Optional HTML that displayed on “main” blog index.rst files.
...
# output / TRANSLATION[lang] / ARCHIVE_PATH / YEAR / index.rst
# output / TRANSLATION[lang] / ARCHIVE_PATH / YEAR / MONTH / index.rst
# output / TRANSLATION[lang] / ARCHIVE_PATH / YEAR / MONTH / DAY / index.rst
# (translatable)
ARCHIVE_PATH = "blog"
...
# newest) index page (index.rst):
# INDEXES_PAGES_MAIN = False
#
# If the following is True, index-1.html has the oldest posts, index-2.html the
# second-oldest posts, etc., and index.rst has the newest posts. This ensures
...
# prettier URLs for index pages, such as page/2/index.rst instead of index-2.html.
...
CONTENT_FOOTER = '''
<nav class="navbar navbar-expand-md navbar-light bg-white static-top"><div class="collapse navbar-collapse bs-nav-collapsible" id="bs-navbar">
  <ul class="navbar-nav nav-fill d-flex w-100">
    <li class="nav-item"><a href="blog/archive.html" class="nav-link">Archive</a></li>
    <li class="nav-item"><a href="categories/" class="nav-link">Tags</a></li>
    <li class="nav-item"><a href="rss.xml" class="nav-link">RSS feed</a></li>
  </ul>
</nav>
'''
...
# Create index.rst for page folders?
...
# Defaults to index.rst
# Common other alternatives: default.html for IIS, index.php
# INDEX_FILE = "index.rst"

# If a link ends in /index.rst,  drop the index.rst part.
...
# Instead of putting files in <slug>.html, put them in <slug>/index.rst.
